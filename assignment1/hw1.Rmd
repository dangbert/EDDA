...
We can consider male babies to be population1, and female babies to be
population2. We'll call a "success" when a baby is born \< 2600 grams.
Based on the results of our proportion test results above, we reject the
$H_0$ that the proportion of babies born \< 2600 grams differs between
