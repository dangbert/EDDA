...
titanic$Ager = round_any(titanic$Age, 10)
...
#plot(titanic$age, y=titanic$survival, xlim=c(0, 100))
totage = xtabs(~Age, data=titanic)
barplot(xtabs(Survived~Age,data=titanic)/totage, main="% Cancer by Age group", xlab="Age Group", ylab="Cancer Ratio")
